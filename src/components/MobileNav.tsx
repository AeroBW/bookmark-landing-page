      ...
      <Presence>
        ...
        >
          <Motion.div
            ...
            exit={{ scaleY: 0, y: "-50%" }}
            transition={{ duration: 0.7, easing: [0.32, 0.72, 0, 1] }}
            class="bg-dark-blue/95 fixed top-0 left-0 h-dvh w-dvw origin-top"
          >
            <div class="box flex h-full flex-col">
                  ...
                  <For each={navItems}>
                    {(item, i) => (
                      <li class="text-center">
                        <hr class="border-grayish-blue/40" />
                        <a
              ...
              <a
                href="/login"
                class="mt-6 block w-full rounded-md border-2 border-white bg-transparent py-2 text-center text-white uppercase"
              >
                Login
              </a>

              <div class="mt-auto mb-12 flex items-center justify-center gap-8">
                <a
