...
function MobileNav() {
  ...
  return (
    <>
      ...
      >
        <div class="fixed left-0 top-0 h-dvh w-dvw bg-dark-blue/95">
          <div class="box flex h-full flex-col">
            ...
            <a
              href="/login"
              class="mt-6 block w-full rounded-md border-2 border-white bg-transparent py-2 uppercase text-white"
            >
              Login
            </a>

            <div class="mb-12 mt-auto flex items-center justify-center gap-8">
              <a
