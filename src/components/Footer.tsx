...
function Footer() {
  return (
    <footer class="bg-dark-blue py-16 text-white lg:py-10">
      <div class="box flex items-center gap-8 max-lg:flex-col lg:gap-16">
        <a href="/">
        ...
        <nav>
          <ul class="flex items-center gap-6 uppercase max-lg:flex-col lg:gap-10">
            <For each={navItems}>
              {(item) => (
                <li>
                  <a
        ...
        <div class="flex items-center justify-center gap-8 lg:ml-auto">
          <a href="https://facebook.com" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              class="fill-white transition duration-100 ease-in-out hover:fill-soft-red"
            >
              <path
                fill-rule="evenodd"
